...
from app.routers import auth, buses, devices, fields, health, katie_account, katie_admin, katie_friends, locations
...
app.add_middleware(
    ...
    allow_headers=["Content-Type", "Accept", "Authorization", "X-Katie-Admin"],
    max_age=600,
)
